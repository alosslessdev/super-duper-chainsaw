...
('2024-07-09', '2024-07-12', 'Prepare presentation for quarterly review.', 'Media', 'Quarterly Review Prep', 4, '3 dias'),
('2024-07-15', NULL, 'Investigate bug in payment processing system.', 'Alta', 'Payment Bug Fix', 4, '2 dias'),
('2024-07-03', '2024-07-04', 'Set up development environment for new project.', 'Media', 'Dev Environment Setup', 4, '1 dia'),
('2024-07-06', '2024-07-07', 'Attend team meeting and provide status updates.', 'Baja', 'Team Meeting', 3, '1 dia'),
('2024-07-08', '2024-07-14', 'Research new technologies for front-end development.', 'Media', 'Front-end Tech Research', 4, '6 dias');
